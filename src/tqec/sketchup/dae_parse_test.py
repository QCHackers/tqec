...
def test_parse_library_nodes():
    library_nodes = parse_dae_file_to_nodes(TEST_DIR / 'library.dae')
...
def test_parse_cnot_nodes():
    ...
    assert nodes_by_type == {
        ...
        "zxx": [(0, 3, 3)],
        "zox": [(0, 3, 3)],
        "zxo": [(0, 0, 1), (0, 0, 4), (0, 0, 7), (0, 3, 4), (3, 3, 1), (3, 3, 4), (3, 3, 7)],
        "zxz": [(0, 0, 0), (0, 0, 3), (0, 0, 6), (0, 0, 9), (0, 3, 6), (3, 3, 0), (3, 3, 3), (3, 3, 6), (3, 3, 9)],
    }
